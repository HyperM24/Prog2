public class Main
{
    ...
    static String fixStart(String s)
    {
        ...
        String csere =  s.substring(1).replace(elso, '*');
    ...
    {
        String elso = a.substring(0, 2);
        String masodik = b.substring(0,2);

        String csere = a.replace(elso, masodik) + " " + b.replace(masodik, elso);
