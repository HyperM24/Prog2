public class Csodalatoselem {
    ...
    public static String decode(String szoveg) {
        return szoveg.replace("3", "E")
                .replace("4", "A")
                .replace("5", "S")
                .replace("0", "O")
                .replace("1", "I")
    ...
    public static void main(String[] args) {
        ...
        String dekodolt_szoveg = decode(szoveg);
        System.out.println(dekodolt_szoveg);
    }
}
