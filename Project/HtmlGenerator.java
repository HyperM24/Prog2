...
public class HtmlGenerator {
    ...
    // Főoldal generálása
    public void generateStartPage() throws IOException {
        File startFile = new File(rootDir, "start.html");
        try (FileWriter writer = new FileWriter(startFile)) {
            writer.write("<html><head><style>\n");
            writer.write("body { font-family: Arial, sans-serif; margin: 0; padding: 0; }\n");
            writer.write("a { text-decoration: none; color: blue; font-size: 18px; font-weight: bold; }\n");
            writer.write("hr { margin: 10px 0; border: 0; border-top: 1px solid #ccc; }\n");
            writer.write("</style></head><body>\n");

            // A START PAGE linket dinamikusan generáljuk, mindig a fő könyvtár
            // index.html-jére
            String startPagePath = getRelativePath(new File(rootDir, "index.html"), rootDir);
            writer.write("<p><a href=\"" + startPagePath + "\">START PAGE</a></p>\n");
